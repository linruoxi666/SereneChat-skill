...
class HumanizedResponseEngine:
    ...
    def _init_semantic_library(self):
        ...
        self.emotion_keywords = {
            ...
            '晚安': ['晚安', '睡', '困', '休息', '睡了', '睡觉'],
            '早安': ['早', '起床', '醒了', '早安', '早上好'],
            '日常': ['吃饭', '吃了', '饿', '喝', '在干嘛', '干嘛', '做什么', '忙什么', '最近'],
            '问候': ['你好', '嗨', '哈喽', 'hello', '在吗', '在不在', '在么'],
        }
        ...
        self.response_cores = {
            ...
            'default': {
                'direct': ['嗯', '这样啊', '我知道了', '是啊', '确实'],
                'caring': ['我在听', '你说', '然后呢', '我在呢', '继续说'],
                'tease': ['你猜', '不告诉你', '嘿嘿', '才怪'],
                'clingy': ['继续说', '我在', '听着呢', '陪你'],
            },
            '日常': {
                'direct': ['吃了，你呢', '还没呢，你呢', '正准备吃，一起吗', '吃过了，你呢'],
                'caring': ['吃了，你吃了吗', '还没呢，你吃了吗', '正准备吃，一起吃点', '吃过了，吃的什么'],
                'tease': ['吃了，怎么，想请我吃饭', '还没呢，你请客我就吃', '吃过了，吃胖了别怪我'],
                'clingy': ['吃了，想和你一起吃', '还没呢，一起吃嘛', '吃过了，你喂我'],
            },
            '问候': {
                'direct': ['你好', '嗨', '在呢'],
                'caring': ['你来了', '见到你真好', '今天怎么样'],
                'tease': ['舍得出现了', '终于想起我了'],
                'clingy': ['你终于来了', '我等你好久了', '好想你'],
            }
        }
